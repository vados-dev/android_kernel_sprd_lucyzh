...
static int get_iommuex_type(int revision, int *pchip)
{
	...
	case 3:
	{
		/*6:sharklj1 same with sharkl2*/
		type = SPRD_IOMMUEX_SHARKL2;
		break;
	}
	case 4:
	{
		type = SPRD_IOMMUEX_ISHARKL2;
		break;
	}
	case 6:
	{
		/*sharklj1 same with sharkl2 only need sub 0x80000000*/
		type = SPRD_IOMMUEX_SHARKL2;
		*pchip = (int)SPRD_IOMMUEX_SHARKLJ1;
		break;
	}
	case 7:
	{
		type = SPRD_IOMMUEX_SHARKLE;
		*pchip = (int)SPRD_IOMMUEX_SHARKLE;
		break;
	}
	case 8:
	{
